...
function flashMessage(content, state = 'danger')
{
    content.icon = 'bi bi-exclamation-triangle';
...
function flashMessage(content, state = 'warning')
{
    content.icon = 'bi bi-exclamation-triangle';
